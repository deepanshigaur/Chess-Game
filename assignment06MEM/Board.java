...
public class Board {
	...
	public void doNewCommand(Command cm) {
	    ...
	    int iccf = (cm instanceof Move) ? ((Move) cm).iccf : ((Capture) cm).iccf;
	    Memento mem = originator.saveStateToMemento(this, iccf);
	...
	public void undoCommand() {
		...
		undoneStack.push(cm);
		//originator.getStateFromMemento(mem);
		originator.getStateFromMemento(this,mem);
	    }
	}
